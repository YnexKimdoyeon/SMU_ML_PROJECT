...
def get_cli_args(job='resnet152', run_phase = 'train', aug_level=0, dataclass='0'):
    ...
    if os.name == 'nt':
        print("여기")
        dir_solution_home = r'C:\Users\Doyeon\Desktop\pill_ai\static\model\First_Model\model'
        BATCH_SIZE = 2
        num_workers = 2
        num_threads = 1
        dist_backend = 'gloo'
        ...
        dir_solution_home = r'/Users/dotori/Downloads/AI 모델 소스코드/평가용 데이터셋'
        num_workers = 4
        num_threads = 2
        dist_backend = 'nccl'
        BATCH_SIZE = 8
    ...
    DIR_PROJ = os.path.join(dir_solution_home, 'pill_data/proj_pill')
